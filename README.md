...
הגדרת משתני סביבה: צרו קובץ .env והזינו את המפתחות: OPENAI_API_KEY, COHERE_API_KEY.

בניית האינדקס: הריצו python ingest.py.

חילוץ נתונים מובנים: הריצו python extract_data.py.

הפעלת הסוכן: הריצו python app.py.
